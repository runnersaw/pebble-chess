      ...
      if ((m+n)%2==1) { // black square
        if (get_piece_at_position(board_state,n,m)>0) { // is white
          if (get_piece_at_position(board_state,n,m) == WHITE_PAWN) {
            graphics_draw_bitmap_in_rect(ctx, s_white_pawn_black, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_ROOK) {
            graphics_draw_bitmap_in_rect(ctx, s_white_rook_black, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_QUEEN) {
            graphics_draw_bitmap_in_rect(ctx, s_white_queen_black, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_BISHOP) {
            graphics_draw_bitmap_in_rect(ctx, s_white_bishop_black, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_KNIGHT) {
            graphics_draw_bitmap_in_rect(ctx, s_white_knight_black, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_KING) {
            graphics_draw_bitmap_in_rect(ctx, s_white_king_black, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          }
        } else { //black
        ...
        if (get_piece_at_position(board_state,n,m)>0) { // white piece
          if (get_piece_at_position(board_state,n,m) == WHITE_PAWN) {
            graphics_draw_bitmap_in_rect(ctx, s_white_pawn_white, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_ROOK) {
            graphics_draw_bitmap_in_rect(ctx, s_white_rook_white, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_QUEEN) {
            graphics_draw_bitmap_in_rect(ctx, s_white_queen_white, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_BISHOP) {
            graphics_draw_bitmap_in_rect(ctx, s_white_bishop_white, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_KNIGHT) {
            graphics_draw_bitmap_in_rect(ctx, s_white_knight_white, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          } else if (get_piece_at_position(board_state,n,m) == WHITE_KING) {
            graphics_draw_bitmap_in_rect(ctx, s_white_king_white, GRect(n*WIDTH/8+LEFT_BORDER+1,m*WIDTH/8+TOP_BORDER+1,15,15));
          }
        } else {  // black piece
          if (get_piece_at_position(board_state,n,m) == BLACK_PAWN) {
